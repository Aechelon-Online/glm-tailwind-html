const articles = [
    { title: 'Elevating Private Events: The Perfect Blend of a Solo-Acoustic Guitar Player/Singer and DJ', link:'https://greglucemusic.com/blog/index.html', pic:'/images/dj-solo-musician.webp'},
    { title: 'Event DJ Services: Elevate Your Occasion with Expert Entertainment', link:'https://greglucemusic.com/blog/event-dj-services-expert-entertainment/index.html', pic:'/images/event-dj-back.webp'},
    { title: 'Emerging Party DJ Trends in 2023: Shaping the Sound of the Next Generation', link:'https://greglucemusic.com/blog/emerging-party-dj-trends-in-2023/index.html', pic:'/images/turntable-wavier-lights.webp'},
    { title: 'Setting the Beat: Current Party DJ Industry Trends', link:'https://greglucemusic.com/blog/current-party-dj-industry-trends/index.html', pic:'/images/dj-mixing-at-party.webp'},
